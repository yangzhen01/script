...
def Usage():
    prompt = """\033[1;34mUsage: python %s [PROJECT_ID]
       ...
       If you only print total resources of projects, please set PRJECT_NAME empty.
       Besides printing total resources of projects, if you plan to print reources of specify projects,
       you should set PROJECT_NAME, the argument can be multiple value separated by commas.

Example:
python %s
python %s project1 project2...\033[0m""" % (sys.argv[0], sys.argv[0], sys.argv[0])
    print(prompt)
